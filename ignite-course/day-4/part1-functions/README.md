...
Your journey towards Javascript enlightenment starts in the koans/AboutFunctions.js file.
...
The first error will be in koans/AboutFunctions.js. Fix the first test and
